...
/* 2026-08-21-1 */	UPDATE categories SET `parameters` = REPLACE(`parameters`, '&show[element_medium_id]=1', '&form_show[certificateelements.element_medium_id]=1') WHERE `parameters` LIKE '%&show[element_medium_id]=1%';
